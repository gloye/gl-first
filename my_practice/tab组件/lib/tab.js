...
class Tabs {
    ...
    constructor(options) {
        this.options = jquery.extend({}, Tabs.defaultOptions, options);
    ...
    _initElement() {
        ...
        this.tabs = jquery(this.options.tabs);
        this.panels = jquery(this.options.panels);
        this.nav = jquery(this.options.nav);
        this.content = jquery(this.options.content);
    ...
    _switchTabs(toIndex) {
        ...
        tabs.eq(fromIndex).removeClass(this.selector.ACTIVE);
        tabs.eq(toIndex).addClass(this.selector.ACTIVE);
    }
    ...
    _getPanelInfo(toIndex) {
        ...
        return {
            toIndex: toIndex,
            fromIndex: fromIndex,
            toPanels: jquery(toPanels),
            fromPanels: jquery(fromPanels)
        };
    }
